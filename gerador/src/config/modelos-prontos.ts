...
export interface ModeloPronto {
    ...
    templateEspecial?: 'assistente-tecnico-pericial';
    valorPadrao?: string;
...
export const modelosProntos: ModeloPronto[] = [
    ...
    { id: 'assistente-tecnico-pericial', nome: 'Assistente Técnico Pericial', categoria: 'Assessoria', descricao: 'Gestão e assessoria técnica pericial em processo judicial trabalhista, com suporte especializado em Engenharia de Segurança do Trabalho.', icone: 'fas fa-gavel', cor: '#2c7a7b', servicos: ['Gestão e Assessoria Técnica Pericial', 'Atuação como Assistente Técnico em processo judicial trabalhista'], entregaveis: ['Análise da petição inicial e da documentação de SST', 'Suporte técnico ao departamento jurídico', 'Elaboração de quesitos técnicos', 'Acompanhamento da diligência pericial', 'Parecer técnico', 'Análise do laudo judicial', 'Impugnações, manifestações e quesitos complementares'], fundamentacao: 'Normas Regulamentadoras, legislação trabalhista e fundamentos técnico-científicos aplicáveis à perícia judicial.', campos: [], templateEspecial: 'assistente-tecnico-pericial', valorPadrao: '2.000,00', pagamentoPadrao: 'Entrada — na assinatura da contratação — R$ 500,00\n1ª parcela — 30 dias após a assinatura — R$ 500,00\n2ª parcela — 60 dias após a assinatura — R$ 500,00\n3ª parcela — 90 dias após a assinatura — R$ 500,00\nPagamento via Pix, transferência bancária ou boleto bancário.', fonte: 'TM0126 Hotel Ibis e TM0138 H2 Engenharia' },
