...
export const managementEntries = [
    defineEntry({
        ...
        deliverables: ['Relatório técnico com fatores identificados, critérios de análise, adesão da população e limitações dos resultados.', 'Plano de ação organizacional com prioridades e responsáveis a pactuar com a contratante.', 'Devolutiva dos resultados agregados e orientação para integração ao PGR.'],
        references: ['NR-01 — Gerenciamento de Riscos Ocupacionais.'], provider: [...provider, 'Restringir acesso às respostas e apresentar resultados agregados, evitando a identificação de participantes em grupos pequenos.'],
        ...
        exclusions: ['Palestras, campanhas e reavaliações não selecionadas na proposta.', 'Diagnóstico clínico individual, psicoterapia e emissão de atestado de aptidão.'],
    ...
    defineEntry({
        ...
        references: ['Manual de Orientação do eSocial e leiautes aplicáveis aos eventos contratados.'],
    ...
    defineEntry({
        ...
        scope: ['Visitas e orientações técnicas conforme plano contratado.', 'Acompanhamento das prioridades, responsáveis e pendências das ações de SST.', 'Organização do atendimento e da documentação individualizados por empresa.'],
        ...
        deliverables: ['Registros das visitas e orientações técnicas contratadas.', 'Relatórios de acompanhamento com ações, pendências, responsáveis e encaminhamentos para decisão da contratante.'], references: [], provider, client: [...client, common.implementation],
        inclusions: ['Rotina de atendimento descrita nos parâmetros da assessoria.'],
        exclusions: ['Programas, avaliações, treinamentos e registros não selecionados na proposta.', 'Alocação permanente, plantão de emergência e assistência judicial não contratados.'],
